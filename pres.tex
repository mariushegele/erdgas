...
\begin{frame}{Motivation}
  ...
  \begin{itemize}
    ...
    \item 14.06: Gazprom schickt nur noch 0.7 statt 1.7 TWh/d (-59\%) durch Nord Stream Leitung (Reparaturarbeiten)\footfullcite{gazprom-gasverknappung}
  \end{itemize}
  }
\end{frame}
...
\begin{frame}{Langfristiger Ersatz im Wärmesektor}
 \begin{itemize} 
    ...
    \item Regenerative Wärmequellen: Solarthermie, Geothermie, (Abfallverbrennung, Biomasse)
      (mit Erdbecken-Wärmespeicher) \footfullcite{clausen2022}
